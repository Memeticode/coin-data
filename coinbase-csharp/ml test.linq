...
//	var sdcaEstimator = context.BinaryClassification.Trainers.SdcaLogisticRegression();
//
//	// Train machine learning model
//	//var trainedModel = sdcaEstimator.Fit(transformedTrainingData);
//	var trainedModel = sdcaEstimator.Fit(dataPrepEstimator.);
//
...
//	
//	//Console.WriteLine();
//	//Console.WriteLine($"Accuracy: {trainedModelMetrics.Accuracy:P1}");
//	//Console.WriteLine($"AUC: {trainedModelMetrics.AreaUnderPrecisionRecallCurve:P1}");
//	//Console.WriteLine($"F1: {trainedModelMetrics.F1Score:P1}");
//	//Console.WriteLine();
//	
//	trainedModelMetrics.Dump();
